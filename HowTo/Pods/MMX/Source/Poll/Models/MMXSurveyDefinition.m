...
@implementation MMXSurveyDefinition
...
+ (NSDictionary *)listAttributeTypes {
    NSMutableDictionary *dictionary = [NSMutableDictionary dictionaryWithDictionary:@{
        @"questions" : MMXSurveyQuestion.class,
    }];
...
+ (NSDictionary *)enumAttributeTypes {
    NSMutableDictionary *dictionary = [NSMutableDictionary dictionaryWithDictionary:@{
        @"participantModel" : MMXSurveyParticipantModelContainer.class,
        @"resultAccessModel" : MMXSurveyParticipantModelContainer.class,
        @"type" : MMXSurveyTypeContainer.class,
    }];
