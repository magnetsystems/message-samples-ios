...
let kStr_BlockedUser = localizedString("[BLOCKED]")
...
let kStr_UnblockUserConfirmation = localizedString("Are you sure you want to unblock this user? You will start receiving messages from them.")
