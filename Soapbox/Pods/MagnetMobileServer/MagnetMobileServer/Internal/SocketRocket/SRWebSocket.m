...
// Source SHA: https://github.com/square/SocketRocket/tree/a2dd92a13b42e14fee0c93253e464121c1de67d5
...
- (id)initWithURLRequest:(NSURLRequest *)request protocols:(NSArray *)protocols securityPolicy:(AFSecurityPolicy *)securityPolicy
{
    self = [super init];
    if (self) {
        assert(request.URL);
...
- (id)initWithURL:(NSURL *)url protocols:(NSArray *)protocols securityPolicy:(AFSecurityPolicy *)securityPolicy
{
...
- (void)stream:(NSStream *)aStream handleEvent:(NSStreamEvent)eventCode
{
    if (_secure && !_pinnedCertFound && (eventCode == NSStreamEventHasBytesAvailable || eventCode == NSStreamEventHasSpaceAvailable)) {
        ...
        if (self.securityPolicy) {
            ...
            _pinnedCertFound = [self.securityPolicy evaluateServerTrust:secTrust forDomain:self.url.host];
